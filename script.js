...
// Experiment with the class a litle bit
...
class App {
  ...
  _loadMap(position) {
    ...
    // get the current coords of your
  ...
  reset() {
    // Remove all items with the keyword
    localStorage.removeItem('workouts');

    // Location = big object of the browser
    location.reload();
  }
}
